                     ...
                     <div class="mypgservice-box">
                        ...
                        <div class="card mypg-service-box mt-2">
                        	<ul class="list-group list-group-flush">
							    <li class="list-group-item al-mypgform"><a class="qna-alink" href="<%=contextPath%>/member/findMember.do?action=admin">회원정보 수정</a></li>
							    <li class="list-group-item al-myrsvlistform active"><a class="qna-alink" href="<%=contextPath%>/reservation/getlistReservations.do?action=adpage">회원 예약 내역</a></li>
						   </ul>    
                        </div>
                     </div>
                  </div>
