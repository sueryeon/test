			...
			<div class="loginform-leftwrap-container me-4" style="width: 20%;">
	         ...
	         <div class="login-rightwrap-container ms-4" style="width: 80%;">
	         	<div class="d-flex m-auto border-secondary-subtle login-title text-start pb-3 mt-4 pt-5 mb-0">
		         	<h3 class="me-2"><strong>아이디 찾기</strong></h3>
		         	<h3>&#124;</h3>
					<h6 class="lh-lg ms-2"><a href="<%=contextPath%>/member/findMyPwdForm.do">비밀번호 찾기</a></h6>
	         	</div>
				<main class="form-sign mt-4" id="sign_form">
					<form action="<%=contextPath%>/member/findMyId.do" method="post">
						<!-- 이름 입력 -->
						<div class="m-auto">
							<div class="container mb-3" style="width:100%; padding:0px;">
								<div class="idcheck-box col-md-3" style="width:100%;">
									<label for="inputName" class="subtitle-label form-label" style="width:100%;">가입한 회원 이름</label>
						...
						<div class="d-flex justify-content-center mt-4" >
		                    <button type="submit" class="btn btn-primary me-4" id="nextBtn" style="display:none;">다음</button>
	                    </div>
					</form>
				</main>
			</div>
