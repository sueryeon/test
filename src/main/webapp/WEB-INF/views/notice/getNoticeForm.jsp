...
<script>
	function writeCancel(){
		var cancelurl = "<%=contextPath%>/notice/getlistNotice.do";
	...
	<div class="container-fluid p-3 pt-4 bg-light text-dark pb-5">
		<div class="wrap-container justify-center">
			...
			<div class="mt-4" style="width:100%;">
				<form action="<%=contextPath%>/notice/insertNotice.do" method="post" enctype="multipart/form-data">
					<input type="hidden" value="<%=adVO.getAdid() %>" id="nid" name="nid">
					<div class="mb-3">
					...
					<div class="mb-3">
					  ...
					  <textarea class="form-control" id="ncontent" name="ncontent" rows="3" style="min-height:200px;"></textarea>
					</div>
					<div class="mb-3">
				  		<input class="form-control" type="file" id="nimgFile" name="nimgFile">
					</div>
